...
export default function YouTubeQAApp() {
  ...
  const handleSend = async () => {
    ...
    // TODO: Replace this with your actual API call to the Python backend
    // Example:
    // const res = await fetch("http://localhost:8000/ask", {
    //   method: "POST",
    //   headers: { "Content-Type": "application/json" },
    //   body: JSON.stringify({ video_url: videoUrl, question: userMsg.content }),
    // });
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "⚡ Backend not connected yet. Wire up your LangChain API in the handleSend() function inside YouTubeQAApp.jsx.",
        },
      ]);
      setLoading(false);
    }, 1200);
